...
class __TwigTemplate_31c1e835e3e16c1080d337972e47b086c72b6290c695cb0fc1c1614c13aaa1e0 extends Template
{
    private $source;
    private $macros = [];
...
\t\t  \t\t<div class=\"table-cell text-gray-700 px-4 py-2 text-sm\">";
                // line 41
                echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["post"], "createdat", [], "any", false, false, false, 41), "d/m/Y H:i:s"), "html", null, true);
                echo "</div>
\t\t\t    <div class=\"table-cell text-gray-700 px-4 py-2 text-sm\">";
                // line 42
...
\t\t  \t\t<div class=\"table-cell text-gray-700 px-4 py-2 text-sm\">{{ post.createdat|date(\"d/m/Y H:i:s\") }}</div>
...
{% endblock %}", "dashboard/index.html.twig", "/usr/src/app/templates/dashboard/index.html.twig");
    }
}
